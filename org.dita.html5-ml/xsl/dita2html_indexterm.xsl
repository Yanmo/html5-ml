...
>
    ...
    <!--
     function:    Indexterm main template for generating @index-key,
                a class="index-range-begin" and a class="index-range-end".
     param:        - prmIndextermKey
                ...
                - prmMakeEnd
                  Tunnel parameter. This paramter exists to process indexterm[@end] for making a class="index-range-end".
     ...
     return:    div, a class="index-range-begin", a class="index-range-end"
    ...
    <xsl:template match="*[contains(@class, ' topic/indexterm ')]" mode="MODE_PROCESS_INDEXTERM_MAIN">
        ...
        <xsl:choose>
            ...
            <xsl:when test="($endAttrCheck=$INDEX_CHECK_OK) and ($prmMakeEnd or $prmNormalProcessing)">
                <!-- @end is specified. Generate a class="index-range-end"
                ...
                <a class="index-range-end" ref-id="{$refId}"/>
            ...
            <xsl:when test="$prmMakeComplementEnd and (($startAttrCheck=$INDEX_CHECK_OK)
                ...
                <xsl:if test="not($hasEnd)">
                    <!-- Complement a class="index-range-end" -->
                    <a class="index-range-end">
        ...
        <xsl:choose>
            <xsl:when test="string(@start) and $prmDoCheck">
                ...
                <xsl:choose>
                    ...
                    <!-- This case is OK!
                         Stylesheet must generate a class="index-range-end" in appropriate position.
                     -->
